...
while capture.isOpened():
    ...
    for i, result in enumerate(results):
        ...
        if keypoints is None or keypoints.xy is None or len(keypoints.xy[0]) == 0:
            continue

        x_coords = [pt[0] for pt in keypoints.xy[0].tolist()]
        y_coords = [pt[1] for pt in keypoints.xy[0].tolist()]
